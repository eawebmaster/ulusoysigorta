...
jQuery(document).ready(function($){
	...
	if(typeof dttheme_urls !== 'undefined') {
		...
		if(dttheme_urls.stickynav_animation == 'enable') {
			jQuery('body').bind('DOMMouseScroll mousewheel', function(e){
				$('.sticky-wrapper').removeClass('show').removeClass('hide');
				if(e.originalEvent.wheelDelta < 0 || e.originalEvent.detail > 0) {
					$('.sticky-wrapper').addClass('hide');
				} else {
					$('.sticky-wrapper').addClass('show');
				}
			});			
		}
...
(function() {
	...
	function insurancetoggleOverlay() {
	...
	if(jQuery('div.overlay.overlay-hugeinc').length) {
		...
		triggerBttn.addEventListener( 'click', insurancetoggleOverlay );
		closeBttn.addEventListener( 'click', insurancetoggleOverlay );
	}
